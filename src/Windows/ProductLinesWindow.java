 ...
 * @author Luna
 */
public class ProductLinesWindow extends javax.swing.JFrame {

    /**
     * Creates new form ProductLinesWindow
     */
    ...
    private void initComponents() {
        ...
        setTitle("Líneas de Prorductos");

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel1.setText("Lineas de Productos:");

        jButton1.setText("Agregar Línea de Productos");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        AddProductLinedialog apd = new AddProductLinedialog(this,true);
        apd.setVisible(true);
        jComboBox1.setModel(new DBproducts().getProductLines());
        jTextArea2.setText(new DBproducts().findProductLineDescription(jComboBox1.getSelectedItem().toString()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProductLinesWindow.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProductLinesWindow().setVisible(true);
            }
        });
    }
