 ...
 * @author Luna
 */
public class ProductsWindows extends javax.swing.JFrame {

    /**
     * Creates new form ProductsWindows
     */
    public ProductsWindows() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProductsWindows.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProductsWindows().setVisible(true);
            }
        });
    }
