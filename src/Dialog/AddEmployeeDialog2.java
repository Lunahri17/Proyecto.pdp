 ...
 * @author Luna
 */
public class AddEmployeeDialog2 extends javax.swing.JDialog {

    /**
     * Creates new form AddEmployeeDialog2
     */
    public AddEmployeeDialog2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AddEmployeeDialog2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                AddEmployeeDialog2 dialog = new AddEmployeeDialog2(new javax.swing.JFrame(), true);
